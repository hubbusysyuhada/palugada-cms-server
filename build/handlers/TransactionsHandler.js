...
var Transaction_1 = __importDefault(require("../database/entity/Transaction"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, entityManager.find(Transaction_1.default, {})];
                    case 2:
                        data = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOne(Transaction_1.default, { id: id }, {})];
                    case 2:
                        data = _a.sent();
                        rep.code(200).send({ data: data });
                        return [2 /*return*/];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        data = new Transaction_1.default();
                        for (key in req.body) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOneOrFail(Transaction_1.default, { id: id })];
                    case 2:
                        data = _a.sent();
                        for (key in req.body) {
                            data[key] = req.body[key];
                    ...
                    case 3:
                        _a.sent();
                        rep.code(200).send({ message: "Transaction (id: ".concat(id, ") updated") });
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        rep.code(200).send({ message: "Transaction (id: ".concat(id, ") deleted") });
                        return [2 /*return*/];
                }
            });
        });
