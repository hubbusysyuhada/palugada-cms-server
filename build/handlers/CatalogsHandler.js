...
var default_1 = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        q = entityManager.createQueryBuilder(Catalog_1.default, 'catalog')
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOne(Catalog_1.default, { id: id }, {})];
                    case 2:
                        data = _a.sent();
                        rep.code(200).send({ data: data });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOneOrFail(Catalog_1.default, { id: id })];
                    case 2:
                        data = _a.sent();
                        for (key in req.body) {
                            data[key] = req.body[key];
                    ...
                    case 3:
                        _a.sent();
                        rep.code(200).send({ message: "Catalog (id: ".concat(id, ") updated") });
                        return [2 /*return*/];
                }
            });
        });
    ...
    default_1.delete = function (req, rep) {
        return __awaiter(this, void 0, void 0, function () {
            var entityManager, id, data, linkedCategories;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, req.orm.getEm()];
                    case 1:
                    ...
                    case 2:
                        data = _a.sent();
                        return [4 /*yield*/, entityManager.find(Category_1.default, { catalog: { id: id } })];
                    case 3:
                        linkedCategories = _a.sent();
                        if (linkedCategories.length)
                            rep.code(400).send({ message: "Catalog ".concat(data.name, " still in used in Category") });
                        return [4 /*yield*/, entityManager.remove(data).flush()];
                    case 4:
                        _a.sent();
                        rep.code(200).send({ message: "Catalog (id: ".concat(id, ") deleted") });
                        return [2 /*return*/];
                }
            });
        });
...
//# sourceMappingURL=CatalogsHandler.js.map