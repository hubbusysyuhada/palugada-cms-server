...
var default_1 = /** @class */ (function () {
    ...
    default_1.findAll = function (req, rep) {
        return __awaiter(this, void 0, void 0, function () {
            var entityManager, _a, keywords, limit, offset, condition, q, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, req.orm.getEm()];
                    case 1:
                        entityManager = _b.sent();
                        _a = req.query, keywords = _a.keywords, limit = _a.limit, offset = _a.offset;
                        condition = [];
                        if (keywords)
                            condition.push({ name: { $like: "%".concat(keywords, "%") } }, { storage_number: keywords });
                        q = entityManager.createQueryBuilder(Rack_1.default, 'rack')
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOne(Rack_1.default, { id: id }, {})];
                    case 2:
                        data = _a.sent();
                        rep.code(200).send({ data: data });
                        return [2 /*return*/];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOneOrFail(Rack_1.default, { id: id })];
                    case 2:
                        data = _a.sent();
                        for (key in req.body) {
                            data[key] = req.body[key];
                    ...
                    case 3:
                        _a.sent();
                        rep.code(200).send({ message: "Rack (id: ".concat(id, ") updated") });
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        return [4 /*yield*/, entityManager.find(Item_1.default, { rack: { id: id } })];
                    case 3:
                        linkedItems = _a.sent();
                        if (linkedItems.length)
                            rep.code(400).send({ message: "Rack ".concat(data.name, " still in used in Items") });
                        return [4 /*yield*/, entityManager.remove(data).flush()];
                    case 4:
                        _a.sent();
                        rep.code(200).send({ message: "Rack (id: ".concat(id, ") deleted") });
                        return [2 /*return*/];
                }
            });
        });
...
//# sourceMappingURL=RacksHandler.js.map