            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, entityManager.find(RoutePermission_1.default, {}, { fields: ['id', 'name'] })];
                    case 2:
                        data = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        data = new RoutePermission_1.default();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        rep.code(200).send({ message: "RoutePermission (id: ".concat(id, ") updated") });
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        entityManager = _a.sent();
                        id = req.params.id;
                        return [4 /*yield*/, entityManager.findOne(Role_1.default, { permissions: { id: id } })];
                    case 2:
                        isUsed = _a.sent();
                        if (!isUsed) return [3 /*break*/, 3];
                        rep.code(400).send({ message: "Route permission still in used in Role" });
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, entityManager.findOneOrFail(RoutePermission_1.default, { id: id })];
                    case 4:
                        data = _a.sent();
                        return [4 /*yield*/, entityManager.remove(data).flush()];
                    case 5:
                        _a.sent();
                        rep.code(200).send({ message: "RoutePermission (id: ".concat(id, ") deleted") });
                        _a.label = 6;
...
//# sourceMappingURL=RoutePermissionsHandler.js.map