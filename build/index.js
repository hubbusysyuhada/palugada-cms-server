...
var fastify_bcrypt_1 = __importDefault(require("fastify-bcrypt"));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                orm = _a.sent();
                server.register(fastify_bcrypt_1.default, { saltWorkFactor: 5 });
                server.register(routes_1.default, { prefix: 'api' });
                server.register(jwt_1.default, { secret: "secret" });
                server.decorateRequest('orm', orm);
                server.register(static_1.default, {
                    root: path_1.default.join(__dirname, 'out'),
                });
